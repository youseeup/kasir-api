...
func main() {
	...
	// GET localhost:3000/api/produk/{id}
	// PUT localhost:3000/api/produk/{id}
	// DELETE localhost:3000/api/produk/{id}
	...
	// GET localhost:3000/api/produk
	// POST localhost:3000/api/produk
